function c3dTM(filenames,cornernames,threshold)
...
%
%       {'Treadmill_LF','Treadmill_RF','Treadmill_RB','Treadmill_LB'};
%
...
% 
% 5. Functions required:    readC3D, writeC3D, forceTM, checkC3D.
%
%==========================================================================
% OUTPUTS:
%--------------------------------------------------------------------------
...
for n=1:length(filenames)
    ...
    % Fit plane to force plate load cell markers
    f = fit([corners(:,1),corners(:,2)],corners(:,3),'poly11');
    plot(f,[corners(:,1),corners(:,2)],corners(:,3))
    axis equal
