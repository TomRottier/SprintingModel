...
!      &EYpp)
      ! DXpp = DXpp1*COS(Q5) + DYpp1*SIN(Q5)
      ! DYpp = DYpp1*COS(Q5) - DXpp1*SIN(Q5)
      ! DXp  = DXp1* COS(Q5)  + DYp1*SIN(Q5)
      ! DYp  = DYp1* COS(Q5)  - DXp1*SIN(Q5)
      ! DX   = DX1*  COS(Q5)   + DY1*SIN(Q5)
      ! DY   = DY1*  COS(Q5)   - DX1*SIN(Q5)
      ! EXpp = EXpp1*COS(Q5) + EYpp1*SIN(Q5)
      ! EYpp = EYpp1*COS(Q5) - EXpp1*SIN(Q5)
      ! EXp  = EXp1* COS(Q5)  + EYp1*SIN(Q5)
      ! EYp  = EYp1* COS(Q5)  - EXp1*SIN(Q5)
      ! EX   = EX1*  COS(Q5)   + EY1*SIN(Q5)
      ! EY   = EY1*  COS(Q5)   - EX1*SIN(Q5)
