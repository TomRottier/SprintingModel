...
NEWTONIAN N
BODIES A,B,C,D,E,F      
POINTS O,P{7},CM,CMSTANCE,CMSWING
% 
...
POCMX = DOT(P_O_CM>,N1>)
POCMY = DOT(P_O_CM>,N2>)
P_O_CMSTANCE> = CM(O,A,B,C)
P_O_CMSWING> = CM(O,D,E)
...
TORQUE(A/B, ATOR*N3>)   % All extension torques positive
TORQUE(C/B, KTOR*N3>)
TORQUE(C/F, HTOR*N3>)
TORQUE(D/F, SHTOR*N3>)
TORQUE(D/E, SKTOR*N3>)
...
%
% Outputs
OUTPUT T,POP1X,POP1Y,POP2X,POP2Y,POP3X,POP3Y,POP4X,POP4Y,POP5X,POP5Y,POP6X,POP6Y,POP7X,POP7Y,POFOX,POFOY,POCMSTANCEX,POCMSTANCEY,POCMSWINGX,POCMSWINGY,POCMX,POCMY,VOCMX,VOCMY
...
UNITS POP1X=M,POP1Y=M,POP2X=M,POP2Y=M,POP3X=M,POP3Y=M,POP4X=M,POP4Y=M,POP5X=M,POP5Y=M,POP6X=M,POP6Y=M,POP7X=M,POP7Y=M,POFOX=M,POFOY=M
