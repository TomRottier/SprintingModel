...
6021  FORMAT(1X,'FILE: 6segsprint.1 ',//1X,'*** ',99A1,///,8X,'T',12X,'P
     ...
     &OP6Y',10X,'POP7X',10X,'POP7Y',10X,'POPFX',10X,'POPFY',10X,'POCMX',
     &10X,'POCMY',10X,'VOCMX',10X,'VOCMY',/,7X,'(S)',12X,'(M)',12X,'(M)'
     &,12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'
     &(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',1
     &2X,'(M)',12X,'(M)',12X,'(M)',11X,'(M/S)',10X,'(M/S)',/)
...
C**   Evaluate output quantities
     ...
     &N(Q3-Q4-Q5-Q6)
      POPFX = Q1 + FS*COS(Q3) + L6*COS(Q3-Q6) + L4*COS(Q3-Q5-Q6) + L2*CO
     &S(Q3-Q4-Q5-Q6)
      POPFY = Q2 + FS*SIN(Q3) + L6*SIN(Q3-Q6) + L4*SIN(Q3-Q5-Q6) + L2*SI
     &N(Q3-Q4-Q5-Q6)
...
!      &OP5X,POP5Y,POP6X,POP6Y,POP7X,POP7Y,POCMX,POCMY,VOCMX,VOCMY
     ...
     &OP5X,POP5Y,POP6X,POP6Y,POP7X,POP7Y,POPFX,POPFY,POCMX,POCMY,VOCMX,V
     &OCMY
