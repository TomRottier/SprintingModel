...
C**   Created by AUTOLEV 3.2 on Wed Aug 04 16:25:20 2021
...
C**   Quantities which were specified
     ...
     & - VRX - MC*(L7*COS(Q3-Q6-Q7)*(U3-U6-U7)**2+L6*COS(Q3-Q5-Q6-Q7)*(U
     &3-U5-U6-U7)**2-L2*COS(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2) - 0.5D0
     &*MB*(L4*COS(Q3-Q5-Q6-Q7)*(U3-U5-U6-U7)**2+L3*COS(FOOTANG+Q3-Q5-Q6-
     &Q7)*(U3-U5-U6-U7)**2-2*L2*COS(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2)
     & - MD*(L9*COS(Q3-Q7)*(U3-U7)**2+L8*COS(Q3-Q6-Q7)*(U3-U6-U7)**2+L6*
     &COS(Q3-Q5-Q6-Q7)*(U3-U5-U6-U7)**2-L2*COS(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5
     &-U6-U7)**2) - MG*(2*GSp*SIN(Q3)*U3+L10*COS(Q3-Q7)*(U3-U7)**2+L8*CO
     &S(Q3-Q6-Q7)*(U3-U6-U7)**2+L6*COS(Q3-Q5-Q6-Q7)*(U3-U5-U6-U7)**2-COS
     &(Q3)*(GSpp-GS*U3**2)-L2*COS(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2) -
     & ME*((L10-L9)*EApp*SIN(EA-Q3)+L10*COS(Q3-Q7)*(U3-U7)**2+(L10-L9)*C
     &OS(EA-Q3)*(EAp-U3)**2+L8*COS(Q3-Q6-Q7)*(U3-U6-U7)**2+L6*COS(Q3-Q5-
     &Q6-Q7)*(U3-U5-U6-U7)**2-L2*COS(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2
     &) - MF*(L10*EApp*SIN(EA-Q3)+L10*COS(EA-Q3)*(EAp-U3)**2+L10*COS(Q3-
     &Q7)*(U3-U7)**2+L8*COS(Q3-Q6-Q7)*(U3-U6-U7)**2+L6*COS(Q3-Q5-Q6-Q7)*
     &(U3-U5-U6-U7)**2-L12*(EApp-FApp)*SIN(EA-FA-Q3)-L12*COS(EA-FA-Q3)*(
     &EAp-FAp-U3)**2-L2*COS(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2)
      RHS(2) = L1*MA*SIN(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2 - G*MA - G*
     &MB - G*MC - G*MD - G*ME - G*MF - G*MG - RY1 - RY2 - VRY - MC*(L7*S
     &IN(Q3-Q6-Q7)*(U3-U6-U7)**2+L6*SIN(Q3-Q5-Q6-Q7)*(U3-U5-U6-U7)**2-L2
     &*SIN(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2) - 0.5D0*MB*(L4*SIN(Q3-Q5
     &-Q6-Q7)*(U3-U5-U6-U7)**2+L3*SIN(FOOTANG+Q3-Q5-Q6-Q7)*(U3-U5-U6-U7)
     &**2-2*L2*SIN(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2) - MD*(L9*SIN(Q3-
     &Q7)*(U3-U7)**2+L8*SIN(Q3-Q6-Q7)*(U3-U6-U7)**2+L6*SIN(Q3-Q5-Q6-Q7)*
     &(U3-U5-U6-U7)**2-L2*SIN(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2) - MG*
     &(L10*SIN(Q3-Q7)*(U3-U7)**2+L8*SIN(Q3-Q6-Q7)*(U3-U6-U7)**2+L6*SIN(Q
     &3-Q5-Q6-Q7)*(U3-U5-U6-U7)**2-2*GSp*COS(Q3)*U3-SIN(Q3)*(GSpp-GS*U3*
     &*2)-L2*SIN(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2) - ME*((L10-L9)*EAp
     &p*COS(EA-Q3)+L10*SIN(Q3-Q7)*(U3-U7)**2+L8*SIN(Q3-Q6-Q7)*(U3-U6-U7)
     &**2+L6*SIN(Q3-Q5-Q6-Q7)*(U3-U5-U6-U7)**2-(L10-L9)*SIN(EA-Q3)*(EAp-
     &U3)**2-L2*SIN(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2) - MF*(L10*EApp*
     &COS(EA-Q3)+L10*SIN(Q3-Q7)*(U3-U7)**2+L12*SIN(EA-FA-Q3)*(EAp-FAp-U3
     &)**2+L8*SIN(Q3-Q6-Q7)*(U3-U6-U7)**2+L6*SIN(Q3-Q5-Q6-Q7)*(U3-U5-U6-
     &U7)**2-L12*(EApp-FApp)*COS(EA-FA-Q3)-L10*SIN(EA-Q3)*(EAp-U3)**2-L2
     &*SIN(Q3-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2)
      RHS(3) = G*L1*MA*COS(Q3-Q4-Q5-Q6-Q7) + 0.5D0*(2*MG*GS*VRX*SIN(Q3)+
     &2*L12*MF*VRX*SIN(EA-FA-Q3)+2*L12*MF*VRY*COS(EA-FA-Q3)+L3*MB*VRX*SI
     &N(FOOTANG+Q3-Q5-Q6-Q7)+2*(L10*ME+L10*MF+L10*MG+L9*MD)*VRX*SIN(Q3-Q
     &7)+2*(L7*MC+L8*MD+L8*ME+L8*MF+L8*MG)*VRX*SIN(Q3-Q6-Q7)+(L4*MB+2*L6
     &*MC+2*L6*MD+2*L6*ME+2*L6*MF+2*L6*MG)*VRX*SIN(Q3-Q5-Q6-Q7)+2*(L1*MA
     &+L2*MB+L2*MC+L2*MD+L2*ME+L2*MF+L2*MG)*VRY*COS(Q3-Q4-Q5-Q6-Q7)-2*MG
     &*GS*VRY*COS(Q3)-L3*MB*VRY*COS(FOOTANG+Q3-Q5-Q6-Q7)-2*(L10*MF+ME*(L
     &10-L9))*VRX*SIN(EA-Q3)-2*(L10*MF+ME*(L10-L9))*VRY*COS(EA-Q3)-2*(L1
     &0*ME+L10*MF+L10*MG+L9*MD)*VRY*COS(Q3-Q7)-2*(L7*MC+L8*MD+L8*ME+L8*M
     &F+L8*MG)*VRY*COS(Q3-Q6-Q7)-2*(L1*MA+L2*MB+L2*MC+L2*MD+L2*ME+L2*MF+
     &L2*MG)*VRX*SIN(Q3-Q4-Q5-Q6-Q7)-(L4*MB+2*L6*MC+2*L6*MD+2*L6*ME+2*L6
     &*MF+2*L6*MG)*VRY*COS(Q3-Q5-Q6-Q7))/(MA+MB+MC+MD+ME+MF+MG) + 0.5D0*
     &L2*MB*(L4*SIN(Q4)*(U3-U5-U6-U7)**2+L3*SIN(FOOTANG+Q4)*(U3-U5-U6-U7
     &)**2-L4*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L3*SIN(FOOTANG+Q4)*(U3-U4-U5-U
     &6-U7)**2) + MC*(L2*L7*SIN(Q4+Q5)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3-U
     &5-U6-U7)**2+L6*L7*SIN(Q5)*(U3-U5-U6-U7)**2-L6*L7*SIN(Q5)*(U3-U6-U7
     &)**2-L2*L6*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L2*L7*SIN(Q4+Q5)*(U3-U4-U5-
     &U6-U7)**2) + MD*(L2*L9*SIN(Q4+Q5+Q6)*(U3-U7)**2+L8*L9*SIN(Q6)*(U3-
     &U6-U7)**2+L2*L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3-U5-U6-U
     &7)**2+L6*L8*SIN(Q5)*(U3-U5-U6-U7)**2+L6*L9*SIN(Q5+Q6)*(U3-U5-U6-U7
     &)**2-L8*L9*SIN(Q6)*(U3-U7)**2-L6*L9*SIN(Q5+Q6)*(U3-U7)**2-L6*L8*SI
     &N(Q5)*(U3-U6-U7)**2-L2*L6*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L2*L8*SIN(Q4
     &+Q5)*(U3-U4-U5-U6-U7)**2-L2*L9*SIN(Q4+Q5+Q6)*(U3-U4-U5-U6-U7)**2) 
     &+ MG*(2*GS*GSp*U3+2*L10*GSp*COS(Q7)*U3+2*L8*GSp*COS(Q6+Q7)*U3+2*L6
     &*GSp*COS(Q5+Q6+Q7)*U3+L10*SIN(Q7)*(GSpp-GS*U3**2)+L10*GS*SIN(Q7)*(
     &U3-U7)**2+L8*SIN(Q6+Q7)*(GSpp-GS*U3**2)+L10*L2*SIN(Q4+Q5+Q6)*(U3-U
     &7)**2+L10*L8*SIN(Q6)*(U3-U6-U7)**2+L6*SIN(Q5+Q6+Q7)*(GSpp-GS*U3**2
     &)+L2*L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L8*GS*SIN(Q6+Q7)*(U3-U6-U7)**2+L2
     &*L6*SIN(Q4)*(U3-U5-U6-U7)**2+L6*L8*SIN(Q5)*(U3-U5-U6-U7)**2+L10*L6
     &*SIN(Q5+Q6)*(U3-U5-U6-U7)**2+L6*GS*SIN(Q5+Q6+Q7)*(U3-U5-U6-U7)**2-
     &2*L2*GSp*COS(Q4+Q5+Q6+Q7)*U3-L10*L8*SIN(Q6)*(U3-U7)**2-L10*L6*SIN(
     &Q5+Q6)*(U3-U7)**2-L6*L8*SIN(Q5)*(U3-U6-U7)**2-L2*SIN(Q4+Q5+Q6+Q7)*
     &(GSpp-GS*U3**2)-L2*L6*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L2*L8*SIN(Q4+Q5)
     &*(U3-U4-U5-U6-U7)**2-L10*L2*SIN(Q4+Q5+Q6)*(U3-U4-U5-U6-U7)**2-L2*G
     &S*SIN(Q4+Q5+Q6+Q7)*(U3-U4-U5-U6-U7)**2) + MF*(L10*L12*COS(FA)*EApp
     &+L10*L12*COS(FA)*(EApp-FApp)+L10*L12*(EApp-FApp)*COS(EA-FA-Q7)+L10
     &*L2*EApp*COS(EA-Q4-Q5-Q6-Q7)+L12*L8*(EApp-FApp)*COS(EA-FA-Q6-Q7)+L
     &12*L6*(EApp-FApp)*COS(EA-FA-Q5-Q6-Q7)+L10*L12*SIN(FA)*(EAp-FAp-U3)
     &**2+L10*L2*SIN(Q4+Q5+Q6)*(U3-U7)**2+L10*L8*SIN(Q6)*(U3-U6-U7)**2+L
     &10**2*SIN(EA-Q7)*(EAp-U3)**2+L2*L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L10*L1
     &2*SIN(EA-FA-Q7)*(U3-U7)**2+L10*L8*SIN(EA-Q6-Q7)*(EAp-U3)**2+L2*L6*
     &SIN(Q4)*(U3-U5-U6-U7)**2+L6*L8*SIN(Q5)*(U3-U5-U6-U7)**2+L10*L6*SIN
     &(Q5+Q6)*(U3-U5-U6-U7)**2+L10*L6*SIN(EA-Q5-Q6-Q7)*(EAp-U3)**2+L12*L
     &8*SIN(EA-FA-Q6-Q7)*(U3-U6-U7)**2+L12*L2*SIN(EA-FA-Q4-Q5-Q6-Q7)*(EA
     &p-FAp-U3)**2+L12*L6*SIN(EA-FA-Q5-Q6-Q7)*(U3-U5-U6-U7)**2+L10*L2*SI
     &N(EA-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2-L10**2*EApp-L12**2*(EApp-FAp
     &p)-L10**2*EApp*COS(EA-Q7)-L10*L8*EApp*COS(EA-Q6-Q7)-L10*L6*EApp*CO
     &S(EA-Q5-Q6-Q7)-L12*L2*(EApp-FApp)*COS(EA-FA-Q4-Q5-Q6-Q7)-L10*L12*S
     &IN(FA)*(EAp-U3)**2-L10*L8*SIN(Q6)*(U3-U7)**2-L10*L6*SIN(Q5+Q6)*(U3
     &-U7)**2-L10**2*SIN(EA-Q7)*(U3-U7)**2-L6*L8*SIN(Q5)*(U3-U6-U7)**2-L
     &10*L12*SIN(EA-FA-Q7)*(EAp-FAp-U3)**2-L10*L8*SIN(EA-Q6-Q7)*(U3-U6-U
     &7)**2-L2*L6*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L2*L8*SIN(Q4+Q5)*(U3-U4-U5
     &-U6-U7)**2-L10*L2*SIN(EA-Q4-Q5-Q6-Q7)*(EAp-U3)**2-L10*L2*SIN(Q4+Q5
     &+Q6)*(U3-U4-U5-U6-U7)**2-L12*L8*SIN(EA-FA-Q6-Q7)*(EAp-FAp-U3)**2-L
     &10*L6*SIN(EA-Q5-Q6-Q7)*(U3-U5-U6-U7)**2-L12*L6*SIN(EA-FA-Q5-Q6-Q7)
     &*(EAp-FAp-U3)**2-L12*L2*SIN(EA-FA-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2
     &) - IE*EApp - IF*(EApp-FApp) - L2*(RX2*SIN(Q3-Q4-Q5-Q6-Q7)-RY2*COS
     &(Q3-Q4-Q5-Q6-Q7)) - G*MC*(L7*COS(Q3-Q6-Q7)+L6*COS(Q3-Q5-Q6-Q7)-L2*
     &COS(Q3-Q4-Q5-Q6-Q7)) - 0.5D0*G*MB*(L4*COS(Q3-Q5-Q6-Q7)+L3*COS(FOOT
     &ANG+Q3-Q5-Q6-Q7)-2*L2*COS(Q3-Q4-Q5-Q6-Q7)) - G*MD*(L9*COS(Q3-Q7)+L
     &8*COS(Q3-Q6-Q7)+L6*COS(Q3-Q5-Q6-Q7)-L2*COS(Q3-Q4-Q5-Q6-Q7)) - G*MG
     &*(GS*COS(Q3)+L10*COS(Q3-Q7)+L8*COS(Q3-Q6-Q7)+L6*COS(Q3-Q5-Q6-Q7)-L
     &2*COS(Q3-Q4-Q5-Q6-Q7)) - G*ME*(L10*COS(Q3-Q7)+L8*COS(Q3-Q6-Q7)+(L1
     &0-L9)*COS(EA-Q3)+L6*COS(Q3-Q5-Q6-Q7)-L2*COS(Q3-Q4-Q5-Q6-Q7)) - G*M
     &F*(L10*COS(EA-Q3)+L10*COS(Q3-Q7)+L8*COS(Q3-Q6-Q7)+L6*COS(Q3-Q5-Q6-
     &Q7)-L12*COS(EA-FA-Q3)-L2*COS(Q3-Q4-Q5-Q6-Q7)) - ME*((L10-L9)**2*EA
     &pp+L10*(L10-L9)*EApp*COS(EA-Q7)+L8*(L10-L9)*EApp*COS(EA-Q6-Q7)+L6*
     &(L10-L9)*EApp*COS(EA-Q5-Q6-Q7)+L10*L8*SIN(Q6)*(U3-U7)**2+L10*L6*SI
     &N(Q5+Q6)*(U3-U7)**2+L6*L8*SIN(Q5)*(U3-U6-U7)**2+L10*(L10-L9)*SIN(E
     &A-Q7)*(U3-U7)**2+L2*L6*SIN(Q4)*(U3-U4-U5-U6-U7)**2+L2*L8*SIN(Q4+Q5
     &)*(U3-U4-U5-U6-U7)**2+L10*L2*SIN(Q4+Q5+Q6)*(U3-U4-U5-U6-U7)**2+L8*
     &(L10-L9)*SIN(EA-Q6-Q7)*(U3-U6-U7)**2+L2*(L10-L9)*SIN(EA-Q4-Q5-Q6-Q
     &7)*(EAp-U3)**2+L6*(L10-L9)*SIN(EA-Q5-Q6-Q7)*(U3-U5-U6-U7)**2-L2*(L
     &10-L9)*EApp*COS(EA-Q4-Q5-Q6-Q7)-L10*L2*SIN(Q4+Q5+Q6)*(U3-U7)**2-L1
     &0*L8*SIN(Q6)*(U3-U6-U7)**2-L2*L8*SIN(Q4+Q5)*(U3-U6-U7)**2-L2*L6*SI
     &N(Q4)*(U3-U5-U6-U7)**2-L6*L8*SIN(Q5)*(U3-U5-U6-U7)**2-L10*(L10-L9)
     &*SIN(EA-Q7)*(EAp-U3)**2-L10*L6*SIN(Q5+Q6)*(U3-U5-U6-U7)**2-L8*(L10
     &-L9)*SIN(EA-Q6-Q7)*(EAp-U3)**2-L6*(L10-L9)*SIN(EA-Q5-Q6-Q7)*(EAp-U
     &3)**2-L2*(L10-L9)*SIN(EA-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2)
      RHS(4) = L2*(RX2*SIN(Q3-Q4-Q5-Q6-Q7)-RY2*COS(Q3-Q4-Q5-Q6-Q7)) + (L
     &1*MA+L2*MB+L2*MC+L2*MD+L2*ME+L2*MF+L2*MG)*(VRX*SIN(Q3-Q4-Q5-Q6-Q7)
     &-VRY*COS(Q3-Q4-Q5-Q6-Q7))/(MA+MB+MC+MD+ME+MF+MG) - MTOR - G*L1*MA*
     &COS(Q3-Q4-Q5-Q6-Q7) - G*L2*MB*COS(Q3-Q4-Q5-Q6-Q7) - G*L2*MC*COS(Q3
     &-Q4-Q5-Q6-Q7) - G*L2*MD*COS(Q3-Q4-Q5-Q6-Q7) - G*L2*ME*COS(Q3-Q4-Q5
     &-Q6-Q7) - G*L2*MF*COS(Q3-Q4-Q5-Q6-Q7) - G*L2*MG*COS(Q3-Q4-Q5-Q6-Q7
     &) - 0.5D0*L2*(MB*(L4*SIN(Q4)+L3*SIN(FOOTANG+Q4))*(U3-U5-U6-U7)**2+
     &2*MC*(L7*SIN(Q4+Q5)*(U3-U6-U7)**2+L6*SIN(Q4)*(U3-U5-U6-U7)**2)+2*M
     &D*(L9*SIN(Q4+Q5+Q6)*(U3-U7)**2+L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L6*SIN(
     &Q4)*(U3-U5-U6-U7)**2)+2*ME*((L10-L9)*EApp*COS(EA-Q4-Q5-Q6-Q7)+L10*
     &SIN(Q4+Q5+Q6)*(U3-U7)**2+L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L6*SIN(Q4)*(U
     &3-U5-U6-U7)**2-(L10-L9)*SIN(EA-Q4-Q5-Q6-Q7)*(EAp-U3)**2)-2*MG*(2*G
     &Sp*COS(Q4+Q5+Q6+Q7)*U3+SIN(Q4+Q5+Q6+Q7)*(GSpp-GS*U3**2)-L10*SIN(Q4
     &+Q5+Q6)*(U3-U7)**2-L8*SIN(Q4+Q5)*(U3-U6-U7)**2-L6*SIN(Q4)*(U3-U5-U
     &6-U7)**2)-2*MF*(L12*(EApp-FApp)*COS(EA-FA-Q4-Q5-Q6-Q7)+L10*SIN(EA-
     &Q4-Q5-Q6-Q7)*(EAp-U3)**2-L10*EApp*COS(EA-Q4-Q5-Q6-Q7)-L10*SIN(Q4+Q
     &5+Q6)*(U3-U7)**2-L8*SIN(Q4+Q5)*(U3-U6-U7)**2-L6*SIN(Q4)*(U3-U5-U6-
     &U7)**2-L12*SIN(EA-FA-Q4-Q5-Q6-Q7)*(EAp-FAp-U3)**2))
     ...
     &*COS(Q3-Q4-Q5-Q6-Q7) - 0.5D0*(L3*MB*VRX*SIN(FOOTANG+Q3-Q5-Q6-Q7)+(
     &L4*MB+2*L6*MC+2*L6*MD+2*L6*ME+2*L6*MF+2*L6*MG)*VRX*SIN(Q3-Q5-Q6-Q7
     &)+2*(L1*MA+L2*MB+L2*MC+L2*MD+L2*ME+L2*MF+L2*MG)*VRY*COS(Q3-Q4-Q5-Q
     &6-Q7)-L3*MB*VRY*COS(FOOTANG+Q3-Q5-Q6-Q7)-2*(L1*MA+L2*MB+L2*MC+L2*M
     &D+L2*ME+L2*MF+L2*MG)*VRX*SIN(Q3-Q4-Q5-Q6-Q7)-(L4*MB+2*L6*MC+2*L6*M
     &D+2*L6*ME+2*L6*MF+2*L6*MG)*VRY*COS(Q3-Q5-Q6-Q7))/(MA+MB+MC+MD+ME+M
     &F+MG) - MC*(L2*L7*SIN(Q4+Q5)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3-U5-U6
     &-U7)**2-L6*L7*SIN(Q5)*(U3-U6-U7)**2-L2*L6*SIN(Q4)*(U3-U4-U5-U6-U7)
     &**2) - 0.5D0*L2*MB*(L4*SIN(Q4)*(U3-U5-U6-U7)**2+L3*SIN(FOOTANG+Q4)
     &*(U3-U5-U6-U7)**2-L4*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L3*SIN(FOOTANG+Q4
     &)*(U3-U4-U5-U6-U7)**2) - MD*(L2*L9*SIN(Q4+Q5+Q6)*(U3-U7)**2+L2*L8*
     &SIN(Q4+Q5)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3-U5-U6-U7)**2-L6*L9*SIN(
     &Q5+Q6)*(U3-U7)**2-L6*L8*SIN(Q5)*(U3-U6-U7)**2-L2*L6*SIN(Q4)*(U3-U4
     &-U5-U6-U7)**2) - MG*(2*L6*GSp*COS(Q5+Q6+Q7)*U3+L10*L2*SIN(Q4+Q5+Q6
     &)*(U3-U7)**2+L6*SIN(Q5+Q6+Q7)*(GSpp-GS*U3**2)+L2*L8*SIN(Q4+Q5)*(U3
     &-U6-U7)**2+L2*L6*SIN(Q4)*(U3-U5-U6-U7)**2-2*L2*GSp*COS(Q4+Q5+Q6+Q7
     &)*U3-L10*L6*SIN(Q5+Q6)*(U3-U7)**2-L6*L8*SIN(Q5)*(U3-U6-U7)**2-L2*S
     &IN(Q4+Q5+Q6+Q7)*(GSpp-GS*U3**2)-L2*L6*SIN(Q4)*(U3-U4-U5-U6-U7)**2)
     & - ME*(L2*(L10-L9)*EApp*COS(EA-Q4-Q5-Q6-Q7)+L10*L2*SIN(Q4+Q5+Q6)*(
     &U3-U7)**2+L2*L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3-U5-U6-U
     &7)**2+L6*(L10-L9)*SIN(EA-Q5-Q6-Q7)*(EAp-U3)**2-L6*(L10-L9)*EApp*CO
     &S(EA-Q5-Q6-Q7)-L10*L6*SIN(Q5+Q6)*(U3-U7)**2-L6*L8*SIN(Q5)*(U3-U6-U
     &7)**2-L2*L6*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L2*(L10-L9)*SIN(EA-Q4-Q5-Q
     &6-Q7)*(EAp-U3)**2)
     ...
     &-Q7) - 0.5D0*(L3*MB*VRX*SIN(FOOTANG+Q3-Q5-Q6-Q7)+2*(L7*MC+L8*MD+L8
     &*ME+L8*MF+L8*MG)*VRX*SIN(Q3-Q6-Q7)+(L4*MB+2*L6*MC+2*L6*MD+2*L6*ME+
     &2*L6*MF+2*L6*MG)*VRX*SIN(Q3-Q5-Q6-Q7)+2*(L1*MA+L2*MB+L2*MC+L2*MD+L
     &2*ME+L2*MF+L2*MG)*VRY*COS(Q3-Q4-Q5-Q6-Q7)-L3*MB*VRY*COS(FOOTANG+Q3
     &-Q5-Q6-Q7)-2*(L7*MC+L8*MD+L8*ME+L8*MF+L8*MG)*VRY*COS(Q3-Q6-Q7)-2*(
     &L1*MA+L2*MB+L2*MC+L2*MD+L2*ME+L2*MF+L2*MG)*VRX*SIN(Q3-Q4-Q5-Q6-Q7)
     &-(L4*MB+2*L6*MC+2*L6*MD+2*L6*ME+2*L6*MF+2*L6*MG)*VRY*COS(Q3-Q5-Q6-
     &Q7))/(MA+MB+MC+MD+ME+MF+MG) - 0.5D0*L2*MB*(L4*SIN(Q4)*(U3-U5-U6-U7
     &)**2+L3*SIN(FOOTANG+Q4)*(U3-U5-U6-U7)**2-L4*SIN(Q4)*(U3-U4-U5-U6-U
     &7)**2-L3*SIN(FOOTANG+Q4)*(U3-U4-U5-U6-U7)**2) - MC*(L2*L7*SIN(Q4+Q
     &5)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3-U5-U6-U7)**2+L6*L7*SIN(Q5)*(U3-
     &U5-U6-U7)**2-L6*L7*SIN(Q5)*(U3-U6-U7)**2-L2*L6*SIN(Q4)*(U3-U4-U5-U
     &6-U7)**2-L2*L7*SIN(Q4+Q5)*(U3-U4-U5-U6-U7)**2) - MD*(L2*L9*SIN(Q4+
     &Q5+Q6)*(U3-U7)**2+L2*L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3
     &-U5-U6-U7)**2+L6*L8*SIN(Q5)*(U3-U5-U6-U7)**2-L8*L9*SIN(Q6)*(U3-U7)
     &**2-L6*L9*SIN(Q5+Q6)*(U3-U7)**2-L6*L8*SIN(Q5)*(U3-U6-U7)**2-L2*L6*
     &SIN(Q4)*(U3-U4-U5-U6-U7)**2-L2*L8*SIN(Q4+Q5)*(U3-U4-U5-U6-U7)**2) 
     &- MG*(2*L8*GSp*COS(Q6+Q7)*U3+2*L6*GSp*COS(Q5+Q6+Q7)*U3+L8*SIN(Q6+Q
     &7)*(GSpp-GS*U3**2)+L10*L2*SIN(Q4+Q5+Q6)*(U3-U7)**2+L6*SIN(Q5+Q6+Q7
     &)*(GSpp-GS*U3**2)+L2*L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3
     &-U5-U6-U7)**2+L6*L8*SIN(Q5)*(U3-U5-U6-U7)**2-2*L2*GSp*COS(Q4+Q5+Q6
     &+Q7)*U3-L10*L8*SIN(Q6)*(U3-U7)**2-L10*L6*SIN(Q5+Q6)*(U3-U7)**2-L6*
     &L8*SIN(Q5)*(U3-U6-U7)**2-L2*SIN(Q4+Q5+Q6+Q7)*(GSpp-GS*U3**2)-L2*L6
     &*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L2*L8*SIN(Q4+Q5)*(U3-U4-U5-U6-U7)**2)
     & - ME*(L2*(L10-L9)*EApp*COS(EA-Q4-Q5-Q6-Q7)+L10*L2*SIN(Q4+Q5+Q6)*(
     &U3-U7)**2+L2*L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3-U5-U6-U
     &7)**2+L6*L8*SIN(Q5)*(U3-U5-U6-U7)**2+L8*(L10-L9)*SIN(EA-Q6-Q7)*(EA
     &p-U3)**2+L6*(L10-L9)*SIN(EA-Q5-Q6-Q7)*(EAp-U3)**2-L8*(L10-L9)*EApp
     &*COS(EA-Q6-Q7)-L6*(L10-L9)*EApp*COS(EA-Q5-Q6-Q7)-L10*L8*SIN(Q6)*(U
     &3-U7)**2-L10*L6*SIN(Q5+Q6)*(U3-U7)**2-L6*L8*SIN(Q5)*(U3-U6-U7)**2-
     &L2*L6*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L2*L8*SIN(Q4+Q5)*(U3-U4-U5-U6-U7
     &)**2-L2*(L10-L9)*SIN(EA-Q4-Q5-Q6-Q7)*(EAp-U3)**2)
     ...
     &- G*L1*MA*COS(Q3-Q4-Q5-Q6-Q7) - 0.5D0*(L3*MB*VRX*SIN(FOOTANG+Q3-Q5
     &-Q6-Q7)+2*(L10*ME+L10*MF+L10*MG+L9*MD)*VRX*SIN(Q3-Q7)+2*(L7*MC+L8*
     &MD+L8*ME+L8*MF+L8*MG)*VRX*SIN(Q3-Q6-Q7)+(L4*MB+2*L6*MC+2*L6*MD+2*L
     &6*ME+2*L6*MF+2*L6*MG)*VRX*SIN(Q3-Q5-Q6-Q7)+2*(L1*MA+L2*MB+L2*MC+L2
     &*MD+L2*ME+L2*MF+L2*MG)*VRY*COS(Q3-Q4-Q5-Q6-Q7)-L3*MB*VRY*COS(FOOTA
     &NG+Q3-Q5-Q6-Q7)-2*(L10*ME+L10*MF+L10*MG+L9*MD)*VRY*COS(Q3-Q7)-2*(L
     &7*MC+L8*MD+L8*ME+L8*MF+L8*MG)*VRY*COS(Q3-Q6-Q7)-2*(L1*MA+L2*MB+L2*
     &MC+L2*MD+L2*ME+L2*MF+L2*MG)*VRX*SIN(Q3-Q4-Q5-Q6-Q7)-(L4*MB+2*L6*MC
     &+2*L6*MD+2*L6*ME+2*L6*MF+2*L6*MG)*VRY*COS(Q3-Q5-Q6-Q7))/(MA+MB+MC+
     &MD+ME+MF+MG) - 0.5D0*L2*MB*(L4*SIN(Q4)*(U3-U5-U6-U7)**2+L3*SIN(FOO
     &TANG+Q4)*(U3-U5-U6-U7)**2-L4*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L3*SIN(FO
     &OTANG+Q4)*(U3-U4-U5-U6-U7)**2) - MC*(L2*L7*SIN(Q4+Q5)*(U3-U6-U7)**
     &2+L2*L6*SIN(Q4)*(U3-U5-U6-U7)**2+L6*L7*SIN(Q5)*(U3-U5-U6-U7)**2-L6
     &*L7*SIN(Q5)*(U3-U6-U7)**2-L2*L6*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L2*L7*
     &SIN(Q4+Q5)*(U3-U4-U5-U6-U7)**2) - MD*(L2*L9*SIN(Q4+Q5+Q6)*(U3-U7)*
     &*2+L8*L9*SIN(Q6)*(U3-U6-U7)**2+L2*L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L2*L
     &6*SIN(Q4)*(U3-U5-U6-U7)**2+L6*L8*SIN(Q5)*(U3-U5-U6-U7)**2+L6*L9*SI
     &N(Q5+Q6)*(U3-U5-U6-U7)**2-L8*L9*SIN(Q6)*(U3-U7)**2-L6*L9*SIN(Q5+Q6
     &)*(U3-U7)**2-L6*L8*SIN(Q5)*(U3-U6-U7)**2-L2*L6*SIN(Q4)*(U3-U4-U5-U
     &6-U7)**2-L2*L8*SIN(Q4+Q5)*(U3-U4-U5-U6-U7)**2-L2*L9*SIN(Q4+Q5+Q6)*
     &(U3-U4-U5-U6-U7)**2) - MG*(2*L10*GSp*COS(Q7)*U3+2*L8*GSp*COS(Q6+Q7
     &)*U3+2*L6*GSp*COS(Q5+Q6+Q7)*U3+L10*SIN(Q7)*(GSpp-GS*U3**2)+L8*SIN(
     &Q6+Q7)*(GSpp-GS*U3**2)+L10*L2*SIN(Q4+Q5+Q6)*(U3-U7)**2+L10*L8*SIN(
     &Q6)*(U3-U6-U7)**2+L6*SIN(Q5+Q6+Q7)*(GSpp-GS*U3**2)+L2*L8*SIN(Q4+Q5
     &)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3-U5-U6-U7)**2+L6*L8*SIN(Q5)*(U3-U
     &5-U6-U7)**2+L10*L6*SIN(Q5+Q6)*(U3-U5-U6-U7)**2-2*L2*GSp*COS(Q4+Q5+
     &Q6+Q7)*U3-L10*L8*SIN(Q6)*(U3-U7)**2-L10*L6*SIN(Q5+Q6)*(U3-U7)**2-L
     &6*L8*SIN(Q5)*(U3-U6-U7)**2-L2*SIN(Q4+Q5+Q6+Q7)*(GSpp-GS*U3**2)-L2*
     &L6*SIN(Q4)*(U3-U4-U5-U6-U7)**2-L2*L8*SIN(Q4+Q5)*(U3-U4-U5-U6-U7)**
     &2-L10*L2*SIN(Q4+Q5+Q6)*(U3-U4-U5-U6-U7)**2) - ME*(L2*(L10-L9)*EApp
     &*COS(EA-Q4-Q5-Q6-Q7)+L10*L2*SIN(Q4+Q5+Q6)*(U3-U7)**2+L10*L8*SIN(Q6
     &)*(U3-U6-U7)**2+L2*L8*SIN(Q4+Q5)*(U3-U6-U7)**2+L2*L6*SIN(Q4)*(U3-U
     &5-U6-U7)**2+L6*L8*SIN(Q5)*(U3-U5-U6-U7)**2+L10*(L10-L9)*SIN(EA-Q7)
     &*(EAp-U3)**2+L10*L6*SIN(Q5+Q6)*(U3-U5-U6-U7)**2+L8*(L10-L9)*SIN(EA
     &-Q6-Q7)*(EAp-U3)**2+L6*(L10-L9)*SIN(EA-Q5-Q6-Q7)*(EAp-U3)**2-L10*(
     &L10-L9)*EApp*COS(EA-Q7)-L8*(L10-L9)*EApp*COS(EA-Q6-Q7)-L6*(L10-L9)
     &*EApp*COS(EA-Q5-Q6-Q7)-L10*L8*SIN(Q6)*(U3-U7)**2-L10*L6*SIN(Q5+Q6)
     &*(U3-U7)**2-L6*L8*SIN(Q5)*(U3-U6-U7)**2-L2*L6*SIN(Q4)*(U3-U4-U5-U6
     &-U7)**2-L2*L8*SIN(Q4+Q5)*(U3-U4-U5-U6-U7)**2-L10*L2*SIN(Q4+Q5+Q6)*
...
C**   Evaluate output quantities
     ...
     &0*L6*COS(EA-Q5-Q6-Q7)-L12*L2*COS(EA-FA-Q4-Q5-Q6-Q7)))*U7p - (L12*M
     &F*VRX*SIN(EA-FA-Q3)+L12*MF*VRY*COS(EA-FA-Q3)-(L10*MF+ME*(L10-L9))*
     &VRX*SIN(EA-Q3)-(L10*MF+ME*(L10-L9))*VRY*COS(EA-Q3))/(MA+MB+MC+MD+M
     &E+MF+MG) - MF*(L10*L12*COS(FA)*EApp+L10*L12*COS(FA)*(EApp-FApp)+L1
     &0*L12*SIN(FA)*(EAp-FAp-U3)**2+L10*L12*SIN(EA-FA-Q7)*(U3-U7)**2+L12
     &*L8*SIN(EA-FA-Q6-Q7)*(U3-U6-U7)**2+L12*L6*SIN(EA-FA-Q5-Q6-Q7)*(U3-
     &U5-U6-U7)**2+L10*L2*SIN(EA-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2-L10**2
     &*EApp-L12**2*(EApp-FApp)-L10*L12*SIN(FA)*(EAp-U3)**2-L10**2*SIN(EA
     &-Q7)*(U3-U7)**2-L10*L8*SIN(EA-Q6-Q7)*(U3-U6-U7)**2-L10*L6*SIN(EA-Q
     &5-Q6-Q7)*(U3-U5-U6-U7)**2-L12*L2*SIN(EA-FA-Q4-Q5-Q6-Q7)*(U3-U4-U5-
     &U6-U7)**2) - (ME*(L10-L9)*SIN(EA-Q3)+MF*(L10*SIN(EA-Q3)-L12*SIN(EA
     &-FA-Q3)))*U1p - (ME*(L10-L9)*COS(EA-Q3)+MF*(L10*COS(EA-Q3)-L12*COS
     &(EA-FA-Q3)))*U2p - L2*(ME*(L10-L9)*COS(EA-Q4-Q5-Q6-Q7)+MF*(L10*COS
     &(EA-Q4-Q5-Q6-Q7)-L12*COS(EA-FA-Q4-Q5-Q6-Q7)))*U4p - (IE+IF+ME*(L10
     &-L9)*(L10+L10*COS(EA-Q7)+L8*COS(EA-Q6-Q7)+L6*COS(EA-Q5-Q6-Q7)-L9-L
     &2*COS(EA-Q4-Q5-Q6-Q7))-MF*(2*L10*L12*COS(FA)+L10*L12*COS(EA-FA-Q7)
     &+L12*L8*COS(EA-FA-Q6-Q7)+L10*L2*COS(EA-Q4-Q5-Q6-Q7)+L12*L6*COS(EA-
     &FA-Q5-Q6-Q7)-L10**2-L12**2-L10**2*COS(EA-Q7)-L10*L8*COS(EA-Q6-Q7)-
     &L10*L6*COS(EA-Q5-Q6-Q7)-L12*L2*COS(EA-FA-Q4-Q5-Q6-Q7)))*U3p
      SKTOR = G*L12*MF*COS(EA-FA-Q3) + L12*MF*(VRX*SIN(EA-FA-Q3)+VRY*COS
     &(EA-FA-Q3))/(MA+MB+MC+MD+ME+MF+MG) + L12*MF*(L10*COS(FA)*EApp+L10*
     &SIN(EA-FA-Q7)*(U3-U7)**2+L8*SIN(EA-FA-Q6-Q7)*(U3-U6-U7)**2+L6*SIN(
     &EA-FA-Q5-Q6-Q7)*(U3-U5-U6-U7)**2-L12*(EApp-FApp)-L10*SIN(FA)*(EAp-
     &U3)**2-L2*SIN(EA-FA-Q4-Q5-Q6-Q7)*(U3-U4-U5-U6-U7)**2) + L12*MF*(L6
     &*COS(EA-FA-Q5-Q6-Q7)-L2*COS(EA-FA-Q4-Q5-Q6-Q7))*U5p + L12*MF*(L8*C
     &OS(EA-FA-Q6-Q7)+L6*COS(EA-FA-Q5-Q6-Q7)-L2*COS(EA-FA-Q4-Q5-Q6-Q7))*
     &U6p + L12*MF*(L10*COS(EA-FA-Q7)+L8*COS(EA-FA-Q6-Q7)+L6*COS(EA-FA-Q
     &5-Q6-Q7)-L2*COS(EA-FA-Q4-Q5-Q6-Q7))*U7p + (IF-L12*MF*(L10*COS(FA)+
     &L10*COS(EA-FA-Q7)+L8*COS(EA-FA-Q6-Q7)+L6*COS(EA-FA-Q5-Q6-Q7)-L12-L
     &2*COS(EA-FA-Q4-Q5-Q6-Q7)))*U3p - IF*(EApp-FApp) - L12*MF*SIN(EA-FA
     &-Q3)*U1p - L12*MF*COS(EA-FA-Q3)*U2p - L12*L2*MF*COS(EA-FA-Q4-Q5-Q6
     &-Q7)*U4p
      POP1X = Q1
      POP1Y = Q2
