...
6021  FORMAT(1X,'FILE: 6segsprint.1 ',//1X,'*** ',99A1,///,8X,'T',12X,'P
     ...
     &OP6Y',10X,'POP7X',10X,'POP7Y',10X,'POCMX',10X,'POCMY',10X,'VOCMX',
     &10X,'VOCMY',/,7X,'(S)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X
     &,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)'
     &,12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',12X,'(M)',11X,'(M/S)',10X
     &,'(M/S)',/)
...
6023  FORMAT(1X,'FILE: 6segsprint.3 ',//1X,'*** ',99A1,///,8X,'T',13X,'R
     ...
     &M)',10X,'(N/M)',10X,'(N/M)',/)
6024  FORMAT(1X,'FILE: 6segsprint.4 ',//1X,'*** ',99A1,///,8X,'T',12X,'H
     &ANG',11X,'KANG',11X,'AANG',11X,'SHANG',10X,'SKANG',9X,'HANGVEL',8X
     &,'KANGVEL',8X,'AANGVEL',7X,'SHANGVEL',7X,'SKANGVEL',/,7X,'(S)',11X
     &,'(DEG)',10X,'(DEG)',10X,'(DEG)',10X,'(DEG)',10X,'(DEG)',9X,'(DEG/
     &S)',8X,'(DEG/S)',8X,'(DEG/S)',8X,'(DEG/S)',8X,'(DEG/S)',/)
...
C**   Evaluate output quantities
     ...
     &S(DA-Q3)*(DAp-U3-U7) - ME*(L3-L4)*COS(DA-EA-Q3)*(DAp-EAp-U3-U7-U8)
      ...
      SHANGVEL = DAp
      SKANGVEL = EAp
      SHTOR = G*MD*(L5-L6)*COS(DA-Q3) + ME*(L6*(L3-L4)*SIN(EA)*(DAp-U3)*
     &*2-L6**2*DApp-L6*(L3-L4)*COS(EA)*DApp-(L3-L4)**2*(DApp-EApp)-L6*(L
     &3-L4)*COS(EA)*(DApp-EApp)-L6**2*SIN(DA-Q6)*(U3-U6)**2-L6*(L3-L4)*S
     &IN(EA)*(DAp-EAp-U3)**2-L4*L6*SIN(DA-Q5-Q6)*(U3-U5-U6)**2-L6*(L3-L4
     &)*SIN(DA-EA-Q6)*(U3-U6)**2-L2*L6*SIN(DA-Q4-Q5-Q6)*(U3-U4-U5-U6)**2
     &-L4*(L3-L4)*SIN(DA-EA-Q5-Q6)*(U3-U5-U6)**2-L2*(L3-L4)*SIN(DA-EA-Q4
     &-Q5-Q6)*(U3-U4-U5-U6)**2) + L2*(MD*(L5-L6)*COS(DA-Q4-Q5-Q6)-ME*(L6
     &*COS(DA-Q4-Q5-Q6)+(L3-L4)*COS(DA-EA-Q4-Q5-Q6)))*U4p + (MD*(L5-L6)*
     &(L4*COS(DA-Q5-Q6)+L2*COS(DA-Q4-Q5-Q6))-ME*(L4*L6*COS(DA-Q5-Q6)+L2*
     &L6*COS(DA-Q4-Q5-Q6)+L4*(L3-L4)*COS(DA-EA-Q5-Q6)+L2*(L3-L4)*COS(DA-
     &EA-Q4-Q5-Q6)))*U5p + (MD*(L5-L6)*(L6*COS(DA-Q6)+L4*COS(DA-Q5-Q6)+L
     &2*COS(DA-Q4-Q5-Q6))-ME*(L6**2*COS(DA-Q6)+L4*L6*COS(DA-Q5-Q6)+L2*L6
     &*COS(DA-Q4-Q5-Q6)+L6*(L3-L4)*COS(DA-EA-Q6)+L4*(L3-L4)*COS(DA-EA-Q5
     &-Q6)+L2*(L3-L4)*COS(DA-EA-Q4-Q5-Q6)))*U6p + (ID+IE+MD*(L5-L6)*(L5-
     &L6-L6*COS(DA-Q6)-L4*COS(DA-Q5-Q6)-L2*COS(DA-Q4-Q5-Q6))+ME*(L6**2+(
     &L3-L4)**2+2*L6*(L3-L4)*COS(EA)+L6**2*COS(DA-Q6)+L4*L6*COS(DA-Q5-Q6
     &)+L2*L6*COS(DA-Q4-Q5-Q6)+L6*(L3-L4)*COS(DA-EA-Q6)+L4*(L3-L4)*COS(D
     &A-EA-Q5-Q6)+L2*(L3-L4)*COS(DA-EA-Q4-Q5-Q6)))*U3p - ID*DApp - IE*(D
     &App-EApp) - G*ME*(L6*COS(DA-Q3)+(L3-L4)*COS(DA-EA-Q3)) - MD*(L5-L6
     &)*((L5-L6)*DApp-L6*SIN(DA-Q6)*(U3-U6)**2-L4*SIN(DA-Q5-Q6)*(U3-U5-U
     &6)**2-L2*SIN(DA-Q4-Q5-Q6)*(U3-U4-U5-U6)**2) - (MD*(L5-L6)*SIN(DA-Q
     &3)-ME*(L6*SIN(DA-Q3)+(L3-L4)*SIN(DA-EA-Q3)))*U1p - (MD*(L5-L6)*COS
     &(DA-Q3)-ME*(L6*COS(DA-Q3)+(L3-L4)*COS(DA-EA-Q3)))*U2p
