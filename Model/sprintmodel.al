...
VARIABLES U{5}'
VARIABLES RX,RY		% One spring under foot
VARIABLES KECM,PECM,TE,H
...
%
% ------------------------------------------------------------------------------
% Specified variables -  leave blank to get specified variables in common block
%DX   = 0
%DX'  = 0
%DX'' = 0
%DY   = 0
...
OUTPUT T,KECM,KECM2,PECM,TE,TE2,H
...
UNITS Q1=M,Q2=M,Q3=DEG,Q4=DEG,Q5=DEG
UNITS U1=M/S,U2=M/S,U3=DEG/S,U4=DEG/S,U5=DEG/S
